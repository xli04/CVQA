...
from Question_type import show_results_matrix, evaluate_metric, random_dic, save_results_matrix
        ...
        for task_idx, task in enumerate(self.task_list):
            ...
            if args.memory:
                if task_idx != 0:
                    ...
                    # idx-1 memory
                    sample_list_file = os.path.join('datasets/nextqa/Partition_Q/train_'+ f'{self.task_list[task_idx - 1]}.csv')
            ...
            for idx, cateGroup in enumerate(Category_splits_random):
                ...
                for epoch in range(self.args.epochs):
                    ...
                    if len(self.memory_loader_cate) > 0 and len(self.memory_loader_cate.dataset) > 0:
    ...
    def train_step(self, batch, task_idx, epoch_results):
        if self.args.fp16 and _use_native_amp:
            ...
            if self.args.distributed:
                ...
                results = self.model.train_step(batch, task_idx, self.args.proto_alpha, self.args.proto_beta)
